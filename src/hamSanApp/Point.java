...
public class Point {
	...
	/**
	 * gibt zur�ck, ob sich die Geraden i und j oberhalb der Geraden k schneiden
		...
		if (diff1 != 0 && diff2 != 0) {// haben keine Kreuzungen im unendlichen
			...
			if (x1 < x2) {
				...
				return -1;
						...
						// TODO: evtl Test, ob Behantdlung für nur 3 verschiedene Geraden als Eingebe
						// passt
