...
public class HamSanApplet extends JApplet {
	...
	public static void main(String[] args) {
		...
		a.init();
		frame.getContentPane().add(a, "Center");
	...
	public void init() {
		...
		String[] presets = { "random points (square)", "random points (circle)", "random paralel lines", "single random points",
				"all Points on one side", "vertical solution", "only one color", "collinear case", "multiple solutions(1)",
				"multiple solutions(2)", "early stop", "unbounded trapeze" };
		...
		this.addKeyListener(new ToggleListener(colourlabel, pp, doAlgButtonListener, doAllgButtonListener, resetButtonListener,
				randomButtonListener, OldpointsresetButtonListener, resetZoomListener));
